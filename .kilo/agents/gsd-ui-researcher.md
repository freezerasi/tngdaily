...
Use template from `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/templates/UI-SPEC.md`
...
|-------|-------------------|----------------|-------------------------------|
| Dimension {N} | {property} | {locked answer / AGENTS.md rule / spec constraint} | {one line} |
