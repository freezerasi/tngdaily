...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Athira/Desktop/tngdaily/.kilo/.gsd-surface.json`
(sibling to `C:/Users/Athira/Desktop/tngdaily/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Athira/Desktop/tngdaily/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`C:/Users/Athira/Desktop/tngdaily/.kilo/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `~/.config/kilo` as `configDir`. The skill dirs themselves live at
`C:/Users/Athira/Desktop/tngdaily/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-$HOME/.config/kilo}"
SCOPE="global"
...
(i.e. `C:/Users/Athira/Desktop/tngdaily/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Athira/Desktop/tngdaily/.kilo/.gsd-surface.json`
Install profile marker: `C:/Users/Athira/Desktop/tngdaily/.kilo/.gsd-profile`
Skill dirs: `C:/Users/Athira/Desktop/tngdaily/.kilo/skills/gsd-*/`
Engine module: `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/bin/lib/clusters.cjs`
</execution_context>
