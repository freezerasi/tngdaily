...
Key references:
- @C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/references/ui-brand.md (display patterns)
- @C:/Users/Athira/Desktop/tngdaily/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md" "C:/Users/Athira/Desktop/tngdaily/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/references/user-profiling.md`
...
Reference: @C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/Users/Athira/Desktop/tngdaily/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Users/Athira/Desktop/tngdaily/.kilo/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Users/Athira/Desktop/tngdaily/.kilo/AGENTS.md"

**Error handling:** If any `gsd_run query` call fails, display the error message and use question to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```bash
BACKUP_PATH="C:/Users/Athira/Desktop/tngdaily/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Users/Athira/Desktop/tngdaily/.kilo/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.kilo/AGENTS.md>
  ✓ Global AGENTS.md        C:/Users/Athira/Desktop/tngdaily/.kilo/AGENTS.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.kilo/AGENTS.md` but may be overridden by config or `--output`.)
