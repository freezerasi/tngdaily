...
```markdown
Read C:/Users/Athira/Desktop/tngdaily/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Users/Athira/Desktop/tngdaily/.kilo/agents/gsd-ui-checker.md for instructions.
...
you used. Re-check the user's locked answers, capability guidance (AGENTS.md, project skills) and
...
@C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/Users/Athira/Desktop/tngdaily/.kilo.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/Users/Athira/Desktop/tngdaily/.kilo/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
