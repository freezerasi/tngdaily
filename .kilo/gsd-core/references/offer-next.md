...
Read and follow `C:/Users/Athira/Desktop/tngdaily/.kilo/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
